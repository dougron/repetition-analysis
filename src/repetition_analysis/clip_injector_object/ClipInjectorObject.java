package repetition_analysis.clip_injector_object;
...
/*
 * adapted from the version developed for the SortaSelekta, 2016
 */
public class ClipInjectorObject {
	...
	public static StaticUDPConnection conn = new StaticUDPConnection(7800);
	...
	public static void sendTempoMessage(int tempo){
	...
	public static void playTransport() {
		OSCMessMaker mm = new OSCMessMaker();
		mm.addItem(GLOBAL);
		mm.addItem(PLAY);
		conn.sendUDPMessage(mm);
