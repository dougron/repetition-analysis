 ...
 * for the purposes of SelektaAnalysis, takes its port number from RepetitionAnalysisGameFrame
 * should be added to DAUtils, but am lazy.
 */
public class ClipInjectorObject {
	...
	public static StaticUDPConnection conn = new StaticUDPConnection(RepetitionAnalysisGameFrame.sendPort);
